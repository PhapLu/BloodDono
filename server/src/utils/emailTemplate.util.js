        ...
        <body>
            <div class="container">
                ...
                <div style='font-size: 15px;' class="footer">
                    <p>Wander là nền tảng chia sẻ trải nghiệm và đặt chỗ du lịch hàng đầu Việt Nam, nơi đem lại những đánh giá khách quan về các địa điểm du lịch Việt Nam.</p>
                    <span>Hiện tại Wander vẫn còn đang trong giai đoạn thử nghiệm, rất mong nhận được những đóng góp và ý kiến từ các bạn để sản phẩm cải thiện hơn.</span>
                    <p class="footer_final_p">Hẹn gặp lại trên Wander.</p>
                    <p>Mọi thắc mắc và đóng góp xin vui lòng liên hệ <a style='color: #ff9027; font-size: 16px;' class="fiyonce_help" href="mailto:help@wander.com">help@wander.com</a></p>
...
const announcementTemplate = (toEmail, message) => {
    ...
    <body>
        <div class="container">
            ...
            <div style='font-size: 15px;' class="footer">
                <p>Wander là nền tảng vẽ tranh theo yêu cầu hàng đầu Việt Nam, nơi quy tụ những họa sĩ trẻ tài năng từ nhiều trường phái hội họa khác nhau.</p>
                <span>Hiện tại Wander vẫn còn đang trong giai đoạn thử nghiệm, rất mong nhận được những đóng góp và ý kiến từ các bạn để sản phẩm cải thiện hơn.</span>
                <p class="footer_final_p">Hẹn gặp lại trên Wander.</p>
