...
import { announcementTemplate, otpTemplate } from "../utils/emailTemplate.util.js";

async function brevoSendEmail(to, subject, subjectMessage, verificationCode, message, template) {
    console.log('BREVO', to, subject, subjectMessage, verificationCode, message, template);
    ...
    try {
        ...
        const mailOptions = {
            from: '"Wander" <phapluu2k5tqt@gmail.com>',
            to,
            subject,
            html: htmlContent,
        };
